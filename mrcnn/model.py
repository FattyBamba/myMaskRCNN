...
`class DataGenerator(keras.utils.Sequence):
    def init(self, dataset, config, shuffle=True, augment=False, augmentation=None, random_rois=0, batch_size=1,detection_targets=False,                no_augmentation_sources=None, mode='training'):
        ...
        def data_generator(self,batch_images_ids):
                ...
                anchors = Utils.generate_pyramid_anchors(scales=self.config.rpn_anchor_scales,
                                                         ...
                                                         nchor_stride=self.config.rpn_anchor_stride)
                ...
                for i in range(0, len(batch_images_ids)):
                    ...
                    # Skip images that have no instances. This can happen in cases where we train on a subset 
                    # of classes and the image doesn't have any of the classes we care about.
